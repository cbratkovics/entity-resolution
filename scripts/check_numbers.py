#!/usr/bin/env python
"""Claim discipline (docs/BRIEF.md rule 4; the convention is shared with demo 1): every measured number in README.md,
docs/FINDINGS.md, docs/METHODS_CARD.md and docs/adr/*.md is covered by an artifact citation whose value
matches, or sits in a generated block validated by its renderer. Dangling citations fail.

    python scripts/check_numbers.py [paths...]
"""
...
DEFAULT = ["README.md", "docs/FINDINGS.md", "docs/METHODS_CARD.md", "docs/adr"]
