...
ENV PYTHONDONTWRITEBYTECODE=1 \
    PYTHONUNBUFFERED=1 \
    PIP_NO_CACHE_DIR=1 \
    ENTITY_RESOLUTION_ARTIFACTS_DIR=/app/artifacts
...
CMD ["uvicorn", "entity_resolution.serve.app:app", "--host", "0.0.0.0", "--port", "7860"]
