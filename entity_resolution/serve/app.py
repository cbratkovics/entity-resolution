...
from entity_resolution import __version__
from entity_resolution.config import ARTIFACTS_DIR, ENV_PREFIX, PROJECT, cors_origins
from entity_resolution.models import registry
from entity_resolution.serve import marts, schemas

log = logging.getLogger("entity_resolution.serve")
...
app = FastAPI(
    ...
    version=__version__,
    description="Links records of the same organisation across public registers, scored against labelled ground truth. Every response names its model and feature version.",
    lifespan=lifespan,
)
app.add_middleware(
    CORSMiddleware,
