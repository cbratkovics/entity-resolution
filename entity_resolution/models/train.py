...
from entity_resolution import __version__ as package_version
from entity_resolution.config import ARTIFACTS_DIR, PROJECT, RANDOM_STATE
from entity_resolution.data import loader
from entity_resolution.eval import drift
from entity_resolution.eval.evaluator import git_commit
