...
- A third source once the two-source comparison is published: Wikidata items with P1954 are the candidate, profiled in Phase 1 and rejected as side A because every item is linked by construction (ADR-0001).
