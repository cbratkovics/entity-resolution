...
(`13.77 GiB`) and a peak resident set of 9,861,677,056 bytes (`9.18 GiB`), the
...
That run took 729.8 seconds with the loaders' parquet caches already present; the sample
stage took 170.2 seconds, blocking 58.7 seconds, pair features
276.9 seconds and the three methods together 163.5 seconds.
